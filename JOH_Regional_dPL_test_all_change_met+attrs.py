...
#Create a model with the same structure as training
...
nse_results.to_csv(f'/hydro_dl_project/dPL_Experiment/Models_h5/Benckmarks/dPL_LSTM_train15years_531camels_A800.csv', index=False)
