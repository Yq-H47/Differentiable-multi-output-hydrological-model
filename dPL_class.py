...
class regional_DifferentiableEXPHYDRO_Hu(Layer):
    ...
    def heaviside(self, x):
        ...
        #tanh() returns a number in [-1,1]. The larger the value of 5*x, the closer the return value is to 1.
        #The smaller the value of 5*x, the closer it is to -1. When x=0, the return value is also 0.
        return (K.tanh(5 * x) + 1) / 2



    #Function for calculating flex variables (Ps, Pr) in EXO-HYDRO
    ...
    #Function used to calculate snowmelt in EXO-HYDRO - M, M is also a flex variable
    ...
    #Used to calculate evapotranspiration ET in EXO-HYDRO,
    #available water storage capacity Qb in the water collection bucket,
    #and excess runoff (𝑄s) generated when the water collection bucket is saturated
    ...
    #The call function is used to implement the functional logic of this layer
    def call(self, inputs):
        ...
        #outputs: outputs is a tuple, outputs[0] is the output at the last moment
...
class LSTM_postprocess(Layer):
    ...
    def call(self, inputs_x):
        ...
        for t in range(seq_len):
            ...
            #forcing: [seq_len, batch_size, xd_dim]
