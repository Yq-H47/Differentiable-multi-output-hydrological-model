...
class DataforIndividual():
    ...
    #Read weather data and convert units
    def load_forcing_data(self, working_path, huc_id, basin_id):
        ...
        #forcing_data = pd.read_csv(forcing_path, sep=r'\s+', header=0, skiprows=3, engine='python')
    ...
    #Read runoff data and convert units
    def load_flow_data(self, working_path, huc_id, basin_id, area):
        ...
        return flow_data
    #Combine meteorological data with runoff data
    def load_data(self):
        ...
        gc.collect()  # Manually freeing memory
